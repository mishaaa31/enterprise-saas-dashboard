  ...
  return (
    <div className="p-4 lg:p-8">
      ...
      <div className="glass-panel rounded-xl p-8 text-center flex flex-col items-center justify-center min-h-[400px]">
        ...
        <h3 className="text-xl font-medium text-gray-300 mb-2">Account Settings</h3>
        <p className="text-gray-500 max-w-md">
          This section is currently under development. Soon you'll be able to change passwords, update API keys, and configure webhooks here.
        </p>
      </div>
    </div>
  );
